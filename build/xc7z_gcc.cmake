...
set(
    CMAKE_ASM_COMPILER
        "${TC_PATH}${CROSS_COMPILE}as${CMAKE_EXECUTABLE_SUFFIX}"
...
set(
    CMAKE_LINKER
        "${TC_PATH}${CROSS_COMPILE}ld${CMAKE_EXECUTABLE_SUFFIX}"
    CACHE FILEPATH "" FORCE
)
set(
    CMAKE_AR
        "${TC_PATH}${CROSS_COMPILE}gcc-ar${CMAKE_EXECUTABLE_SUFFIX}"
    CACHE FILEPATH "" FORCE
)
set(
    CMAKE_RANLIB
        "${TC_PATH}${CROSS_COMPILE}gcc-ranlib${CMAKE_EXECUTABLE_SUFFIX}"
    CACHE FILEPATH "" FORCE
)
set(
    CMAKE_NM
        "${TC_PATH}${CROSS_COMPILE}gcc-nm${CMAKE_EXECUTABLE_SUFFIX}"
    CACHE FILEPATH "" FORCE
)
set(
    CMAKE_OBJCOPY
        "${TC_PATH}${CROSS_COMPILE}objcopy${CMAKE_EXECUTABLE_SUFFIX}"
    CACHE FILEPATH "" FORCE
)
